...
<script>
	...
	export default {
		...
		methods: {
			...
			copyUrl() {
				let text = this.$config.h5Domain + '/promotionpages/pintuan/order/order?pintuan_id=' + this.groupDetail.pintuan_id +
		...
		onShareAppMessage(res) {
			var path ='/promotionpages/pintuan/order/order?pintuan_id=' + this.groupDetail.pintuan_id +
					'&group_id=' + this.groupDetail.group_id;
