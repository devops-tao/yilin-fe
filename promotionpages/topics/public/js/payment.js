export default {
					...
					success: res => {
						...
						if (res.code >= 0) {
							if (this.orderPaymentData.pay_money == 0) {
								...
								let orderCreateData = uni.getStorageSync('topicOrderCreateData');
								orderCreateData.out_trade_no = res.data;
								uni.setStorageSync('topicOrderCreateData', orderCreateData);
	...
	onShow() {
		...
		var orderCreateData = uni.getStorageSync('topicOrderCreateData');
