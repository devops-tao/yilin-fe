		...
		<mescroll-uni @getData="getData" ref="mescroll" :size="10">
				...
				<view class="cf-container color-line-border">
					<view class="tab">
						<view @click="changeState(1)"><text
								:class="type == 1 ? 'color-base-text active color-base-border-bottom' : ''">我赠送的</text>
						</view>
						<view @click="changeState(2)"><text
								:class="type == 2 ? 'color-base-text active color-base-border-bottom' : ''">我收到的</text>
						</view>
					</view>
				</view>
			...
			<view class="card-no-data" v-else>
				<view class="card-image">
					<image src="https://cs.b2c.niuteam.cn/upload/uniapp/giftcard/detail/no_giving.png" mode=""></image>
				</view>
