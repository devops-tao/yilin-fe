			...
			<view class="site-body">
				<!-- 商品 -->
					<view class="goods-wrap" >
						<view @click="navigateTo(firstData.sku_id)" class="goods-img">
							<image :src="$util.img(firstData.sku_image, { size: 'mid' })" mode="aspectFill"></image>
						</view>
						<view class="goods-info">
							<view @click="navigateTo(firstData.sku_id)" class="goods-name">{{ firstData.sku_name }}</view>
		...
		<uni-popup ref="sitePromotionPopup" type="bottom">
			<view class="promotion-popup popup">
				...
				<scroll-view scroll-y="true" class="popup-body" :class="{ 'safe-area': isIphoneX }">
					<view>
						<view class="order-cell">
							<text class="tit"><text class="promotion-mark ns-gradient-promotionpages-topics-payment" :data-theme="themeStyle">限时秒杀</text></text>
							<view class="box align-right"></view>
						</view>
					</view>
				</scroll-view>
