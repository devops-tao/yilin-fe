	...
	methods: {
			...
			if (this.orderPaymentData.is_virtual == 0) {
				...
				if (this.orderPaymentData.shop_goods_list.local_config.info && this.orderPaymentData
					...
					if (this.orderPaymentData.shop_goods_list.local_config.info.time_week.length == 0 ||
						...
						this.orderPaymentData.shop_goods_list.local_config.info.time_week.indexOf(this.timeInfo.week) >
						-1) {
		...
		verify() {
			...
			if (this.orderPaymentData.is_virtual == 0) {
				...
				if (this.orderCreateData.delivery.delivery_type == 'store' && this.orderCreateData.delivery.store_id ==
					0) {
					this.$util.showToast({
