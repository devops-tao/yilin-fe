			...
			<view class="prize-area">
				<view class="content-wrap">
					<view>
						...
						<canvas :disable-scroll="true" class="canvas" canvas-id="cardsCanvas"  id="canvas" @touchmove="touchMove" :class="{'add-point':add_point == 1}" v-show="!showGuide && !popState"></canvas>
						<!-- #endif -->
...
<script>
	...
	export default {
		...
		methods: {
			...
			// },
			again(){
				this.$util.redirectTo('/otherpages/game/cards/cards' , { id: this.id }, 'redirectTo');
			},
			popChange(e) {
