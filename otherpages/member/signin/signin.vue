<template>
	<view class="signin" :data-theme="themeStyle">
		...
		<view class="sigin-box">
			<view class="sigin-bg">
				<image :src="$util.img('/upload/uniapp/signin/bg4.png')" mode="widthFix"></image>
			</view>
				...
				<view class="member-info">
					<view class="headimg">
						<view class="headimg-img">
							<image :src="headimg ? $util.img(headimg) : $util.getDefaultImage().default_headimg" mode="aspectFill" @error="headimg = $util.getDefaultImage().default_headimg"></image>
						</view>
				...
				<view class="signin-days-wrap">
					...
					<view class="signin-day-list">
						<view class="signin-day-con">
							<scroll-view class="signin-day-scroll" scroll-with-animation="true" :scroll-x="true" :show-scrollbar="false"
							 :scroll-into-view="'id_' + showDay">
								<block v-for="(item, index) in showSignDays">
									...
									<view :id="'id_' + item.day" class="signin-day-item" v-else-if="item.day == signDaysSeries && hasSign == 1"
									 style="background: #FF4544;">
