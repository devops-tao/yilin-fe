						...
						<view class="item-left">
							<view class="item-flex">
								<view class="item-base">
									...
									<image v-else :src="$util.img('/upload/uniapp/hongbao/hongbao_list_img.png')" mode="aspectFit"></image>
								</view>
	...
	export default {
		...
		onShow() {
			...
			if (uni.getStorageSync('token')) {
				...
				setTimeout(() => {
					this.$refs.login.open('/otherpages/hongbao/list/list');
				});
			}		
		},
		methods: {
			...
			toGoodsList(item) {
				this.$util.redirectTo('/otherpages/hongbao/index/index', {
