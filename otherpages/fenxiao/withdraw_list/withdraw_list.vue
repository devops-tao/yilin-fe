	...
	<view :data-theme="themeStyle">
		<view class="withdraw-cate" v-if="token">
			<block v-for="(item, index) in category" :key="index">
				<view class="cate-li" :class="{ 'active color-base-text color-base-bg-before': status == item.id }" @click="slectCate(item.id)">
					{{ item.name }}
				</view>
			</block>
		</view>
	...
	export default {
		...
		onShow() {
			...
			if (uni.getStorageSync('token')) {
				...
				setTimeout(() => {
					this.$refs.login.open('/otherpages/fenxiao/withdraw_list/withdraw_list');
				});
			}
		},
